...
public class WebXml extends WebXMLParser implements Serializable {
	...
	public String getFacesResourceKey(String servletPath, String resourcePath) {
        ...
        if (resourcePath != null) {
            ...
            if (isPrefixMapping()) {
                ...
                if (servletPath.equals(facesFilterPrefix)) {
                ...
                String sessionResourcePrefix = getSessionResourcePrefix();
                if (resourcePath.startsWith(sessionResourcePrefix)) {
                    return resourcePath.substring(sessionResourcePrefix.length(), resourcePath.length()
                    ...
                    if (!sessionResourcePrefix.equals(globalResourcePrefix)
                        ...
                        return resourcePath.substring(globalResourcePrefix.length(), resourcePath.length()
                                - getFacesFilterSuffix().length());
                    }
                    else if (!globalResourcePrefix.equals(resourcePrefix) && resourcePath.startsWith(resourcePrefix)) {

                        return resourcePath.substring(resourcePrefix.length(), resourcePath.length()
                                - getFacesFilterSuffix().length());
                    }
                }
            }
	...
	public String getFacesResourceKey(HttpServletRequest request) {
		return getFacesResourceKey(request.getServletPath(), request.getPathInfo());
	}
